...
public class FirstController {
    ...
    * 작성된 name 속성을 통해 view에서 해당 데이터를 사용할 수 있다.
    * */
    @PostMapping("/search")
    ...
    * Model에 해당 key가 추가될 경우 Session에도 자동 등록된다. */
    ...
    /* @SessionAttribute 만료
    * SessionStatus 라는 세션의 상태를 관리하는 객체의 setComplete 메소드로 세션을 만료시킨다.
    * HttpSession의 invalidate 메소드를 호출해도 세션 값은 만료되지 않고 유지된다.
    *  */
    @GetMapping("/logout")
